...
public class UserRepositoryImpl implements UserRepository {
    ...
    @Override
    public PageResult<User> pageQuery(Pagination pagination) {
        IPage<UserPO> page = new Page<>(pagination.getPage(), pagination.getPerSize());
        ...
        return PageResult.of(pagination, content);
    }
