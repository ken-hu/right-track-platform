...
public class DepartmentController {
    ...
    @GetMapping("/v1/users/me/departments")
    ...
    public TreeResponse<DepartmentListResponse> listDepartments(ListDepartmentsRequest request) {
        List<Department> departments = departmentService.listDepartments(request);
