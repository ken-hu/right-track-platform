...
public class UserAppServiceImpl implements UserAppService {
    ...
    @Override
    public PageResult<UserItemResponse> pageQuery(UserListReq req) {
        PageResult<User> pageResult = userRepository.pageQuery(req);
        return pageResult.convert(pageResult, UserAssembler.INSTANCE::convert);
    }
