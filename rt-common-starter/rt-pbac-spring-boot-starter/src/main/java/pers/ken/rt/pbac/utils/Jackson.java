package pers.ken.rt.pbac.utils;
...
public enum Jackson {
    ...
    public static <T> T jsonNodeToClass(JsonNode jsonNode, TypeReference<T> typeReference) {
        try {
            if (null == jsonNode) {
                return null;
            }
            return OBJECT_MAPPER.readValue(jsonNode.toPrettyString(), typeReference);
        } catch (IOException e) {
