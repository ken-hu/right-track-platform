...
//
//import static pers.ken.rt.common.exception.ServiceCode.ACCESS_DENY;
//
///**
...
//                        .code(ACCESS_DENY.getCode())
//                        .error(ACCESS_DENY.getMessage())
//                        .errorDetail(accessDeniedException.getMessage())
