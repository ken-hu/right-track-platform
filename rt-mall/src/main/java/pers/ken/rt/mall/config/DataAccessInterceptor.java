...
import pers.ken.rt.starter.pbac.permission.data.IDataProvider;
import pers.ken.rt.starter.pbac.permission.data.DataScope;
import pers.ken.rt.starter.pbac.permission.data.PgDataFilterVisitor;
...
public class DataAccessInterceptor implements StatementInspector {
    ...
    public String inspect(String originalSql) {
        ...
        statements.forEach(statement -> statement.accept(pgDataFilterVisitor));
